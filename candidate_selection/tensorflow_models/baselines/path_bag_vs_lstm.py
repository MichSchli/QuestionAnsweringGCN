...
class PathBagVsLstm(AbstractTensorflowModel):
    ...
    def initialize_graph(self):
        ...
        self.lstms = [BiLstm(self.variables, self.model_settings["word_embedding_dimension"]+1, variable_prefix="lstm_" + str(i)) for i in
        ...
        self.attention = Attention(self.model_settings["word_embedding_dimension"]+2, self.variables, variable_prefix="attention", strategy="constant_query")
        ...
        self.final_transformation = MultilayerPerceptron([int((self.model_settings["word_embedding_dimension"]+2)/2) + self.model_settings["entity_embedding_dimension"],
