...
class HypergraphModel:
    ...
    def propagate_scores(self, centroid_scores, centroid_names):
        ...
        for centroid in self.centroids:
            ...
            self.centroid_scores[centroid] = centroid_score_map[centroid]
    ...
    def get_paths_to_neighboring_centroid_formal_todo_rename(self, target_entities):
        ...
        return entity_to_entity, entity_to_event, event_to_entity, events_to_keep, \
               self.entity_to_entity_relation_bags[en_to_en_keep], \
               self.entity_to_event_relation_bags[en_to_ev_keep], \
               self.event_to_entity_relation_bags[ev_to_en_keep]
